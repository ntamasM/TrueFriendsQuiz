/**
 * True Friends Quiz — English Questions
 * {name} is replaced at runtime with the host player's nickname.
 * 200 questions across multiple categories inspired by deep friendship prompts.
 */
QUESTIONS.en = [
  // ── Favorites (1–30) ──
  {
