/**
 * True Friends Quiz — Türkçe Sorular
 * {name} is replaced at runtime with the host player's nickname.
 * Çeşitli kategorilerde 200 soru.
 */
QUESTIONS.tr = [
  // ── Favoriler (1–30) ──
  {
  ...
  },
  {
    ...
    answers: [
      "Evet, efsaneydi",
      "Sadece küçük şakalar",
      "Şakacının ta kendisi",
      "Hiç yapmadı",
    ],
  },
  {
  ...
  },
  {
    ...
    answers: [
      ...
      "İçten bir mektup",
      "Düşünceli hediye",
      "İhtiyacı olduğunda yanında olmak",
    ],
  },
  {
    id: 178,
